            ...
            <div class="row row-header">
                <div class="col-12 col-md-9 row-content">
                    <form activ="" method="post">
                        ...
                        <div class = "form-group row">
                            <div class = "col-lg-5 col-md-5 col-sm-8 mx-auto">
                                <button type="button" class = "btn btn-dark" id="SignIn">Увійти</button>
                            </div>
                        </div>
                        <div class = "row col-lg-8 col-md-8 col-sm-12 mx-auto">
                            <div class = "col-lg-3 col-md-3 col-sm-4 mx-auto">
                                <a href="./signUp.php" class="log-register bg-dark text-white" id="signIn">Зареєструватися</a>
                            </div>
                            <div class = "col-lg-4 col-md-4 col-sm-5 mx-auto">
                                <a href="./signInAdmin.php" class="log-register bg-dark text-white">Увійти як Адмін</a>
                            </div>
                        </div>
                    </form>
                </div>
